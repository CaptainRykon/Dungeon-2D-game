...
[Tooltip("editor Window is work as- give a specific window on the windows pannel")]
...
public class RoomNodeGraphEditor : EditorWindow
{
    ...
    [Tooltip("attribute of main menue ;- allows us to add menue item to main menue and inspector context menus" +
        "and get window is the method in the editor window class inherit from that ")]
    ...
    /// 0 for the first method to call and different number for different method  to call
    /// </summary>

    [OnOpenAsset(0)]  // Need the namespace UnityEditor.Callbacks
    public static bool OnDoubleClickAsset(int instanceID, int line)
    {
        // convert instance id to an object by  the  object when we click on the node  the action will perform
    ...
    /// <summary>
    /// Draw Editor Gui contact to editor windows, make changes by the gui in editor windows
    /// </summary>
    private void OnGUI()
    {
    ...
    [Tooltip("Another fucking implimentation of fucking Dungeon shit algorithm with entire asshole software of creation" +
